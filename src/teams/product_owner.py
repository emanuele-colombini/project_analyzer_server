...
def create_product_owner__functional_analysis_review_task(
        product_owner,
        functional_analysis_task
):
    product_owner__functional_analysis_review_task = Task(
        ...
        output_file='output/product_owner__functional_analysis_review.md',
        agent=product_owner
    )

    return product_owner__functional_analysis_review_task


def create_product_owner__architectural_assessment_review_task(
        product_owner,
        architectural_assessment_task
):
    product_owner__architectural_assessment_review_task = Task(
        ...
        output_file='output/product_owner__architectural_assessment_review.md',
        agent=product_owner
    )

    return product_owner__architectural_assessment_review_task


def create_product_owner__technical_analysis_review_task(
        product_owner,
        technical_analysis_task
):
    product_owner__technical_analysis_review_task = Task(
        ...
        output_file='output/product_owner__technical_analysis_review.md',
        agent=product_owner
    )

    return product_owner__technical_analysis_review_task
